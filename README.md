...
I generate the explanatory variable X as the sum of a between (or cross–sectional or permanent) component [img[http://latex.codecogs.com/gif.latex?\inline \large \xi_{i}]]
